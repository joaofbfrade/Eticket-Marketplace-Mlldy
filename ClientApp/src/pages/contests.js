...
const Contests = () => {
    //const options = json;
    const [data, setcontests] = useState([]);
    ...
    const filter = (musictype) => {
        ...
        let newContests = data.filter(contest => contest.musictype == musictype)
        ...
        return (
            ...
            <div style={{ "background-color": "#1F1F1F" }}
                ...
                <div class>
                    <div>
                        <div className=' p-10 float-right '><Dropdown contests={data} filter={filter} filter2={filter2} options={data} /></div>
                        ...
                        <ContestList contests={data} filter={filter} options={data} />
